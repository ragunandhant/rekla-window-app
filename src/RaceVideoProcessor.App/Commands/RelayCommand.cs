...
namespace RaceVideoProcessor.App.Commands;
...
public sealed class AsyncRelayCommand : ICommand
{
    ...
    public async void Execute(object? parameter)
    {
        ...
        {
            // Closing the application or canceling a tool operation is not a UI error.
        }
        catch (Exception ex)
        {
...
/// <summary>
/// Parameterised command used for sidebar navigation, where the parameter is the
/// destination page name supplied by the XAML.
/// </summary>
